...
新增獨立 `#phak` 入口，內容對應 FAA-H-8083-25C（2023）第 1–17 章。第一章依原書目錄提供 54 節講解，其餘各章五個詳解主題；均有原文定位、重點、兩組易混淆觀念、閱讀問題與一題自編情境檢核；保留個人筆記與已讀進度。附錄、字彙表與索引可由官方全書查閱，本站尚未另外編寫附錄課程。
...
本次僅第一章達此粒度；第 2–17 章仍為各五個主題導讀。章節卡片標明深度。紀錄仍按章保存，尚無逐小節完成標記；原有 Chapter 1 筆記與完成狀態沿用，不因擴充教材而清除。涉及現行資料的附註另連 FAA／eCFR 查核來源，與 2023 年原書分開呈現。
