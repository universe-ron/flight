export const phakDocument = {
  ...
  "chapters": [
    ...
    },
    {
          ...
          "lessonBlocks": [
            {
              ...
              "paragraphs": [
                ...
                "本次深入講解從皮托靜壓系統至磁通閘羅盤入門，配合 Figure 8-1～8-27。後續遠端羅盤、磁羅盤誤差等仍保留原有逐節概述；圖解案例是原理練習，機型操作以適用手冊為準。"
              ],
              "table": {
                "caption": "把儀表分成不同問題",
                "headers": [
          ...
          "lessonBlocks": [
            {
              ...
              "paragraphs": [
                ...
                "感應的關鍵是磁通量隨時間改變；不能把靜止不變的地磁場理解成會在靜止線圈中持續自行發電。交流激磁讓地磁相關訊號可被轉成電訊號，供後續航向同步使用。遠端安裝可減少部分干擾，但仍需合適安裝與校準；本單元先掌握感測原理，後續同步與遠端顯示另有章節。"
              ],
              "figure": {
      ...
      "detailMode": "outline",
      "checked": "2026-09-16",
      "coverageNote": "保留全章 66 節目錄與逐節概述；本次已將前 48 節（導論至磁通閘羅盤入門）展開為 60 個深入單元，附 Figure 8-1～8-27 原圖頁面指引。後續遠端羅盤至章末仍為原有概述。比較表與計算例為本站編寫，並釐清總壓、膜盒、六大飛行儀表及 AHRS 等原文易混淆處。"
    },
    {
      "id": "phak25c-9",
      "number": 9,
