export const phakDocument = {
  ...
  "chapters": [
    ...
    },
    {
      ...
      "detailMode": "outline",
      "checked": "2026-09-15",
      "coverageNote": "保留全章 89 節目錄與逐節基礎講解；目前前 68 節已有深入教材，共 103 個單元，範圍至液壓系統基本元件，附 Figure 7-1～7-36 官方原圖指引、比較表及理解練習。本輪補完油箱並深化燃油、供暖與電氣；圖 7-34～7-36 為配合正文的官方延伸讀圖。液壓目前展開基本流路與力／流量關係，起落架等後續系統尚未進行同一輪深化。操作、燃料與添加劑適用性均依核准資料。"
    },
    {
      "id": "phak25c-8",
      "number": 8,
