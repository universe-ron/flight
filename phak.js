export const phakDocument = {
  ...
  "chapters": [
    ...
    },
    {
      ...
      "detailMode": "outline",
      "checked": "2026-09-14",
      "coverageNote": "保留全章 89 節目錄與逐節基礎講解；本次依提供內容深化前 18 節（導論至渦輪增壓），共 33 個深入單元，附 Figure 7-1～7-15 官方原圖指引、比較表與理解練習。圖 7-15 為配合已提供渦輪增壓正文的官方延伸圖；後續系統尚未進行同一輪深化。具體設定、限制與故障處置依 AFM／POH 及製造商資料。"
    },
    {
      "id": "phak25c-8",
      "number": 8,
