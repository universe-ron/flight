export const phakDocument = {
  ...
  "chapters": [
    ...
    },
    {
          ...
          "lessonBlocks": [
            {
              "title": "油箱開頭：辨認加油口與封蓋",
              "paragraphs": [
                "本次提供的文字介紹常見翼內油箱、上方加油口及油箱蓋。加油口位置方便補充燃油，但不代表從單一口可加滿所有油箱，也不代表目視一個油箱就能確認全機燃油。",
                "油箱蓋的固定與密封關係到滲漏、污染及安裝所需通氣安排。不同機型可能有多個油箱與不同結構，後續應連同原有油量、選擇閥及通氣教材閱讀；此處不從開頭片段推導未提供的全套油箱操作程序。"
              ]
            }
          ]
        },
      ...
      "detailMode": "outline",
      "checked": "2026-09-15",
      "coverageNote": "保留全章 89 節目錄與逐節基礎講解；目前深化前 53 節（導論至油箱開頭），共 77 個深入單元，附 Figure 7-1～7-30 官方原圖指引、比較表及理解練習。圖 7-22 與 7-30 配合提供正文補充官方延伸讀圖；油箱本輪僅展開已提供的開頭，後續系統尚未進行同一輪深化。具體設定、限制與故障處置依 AFM／POH 及製造商資料。"
    },
    {
      "id": "phak25c-8",
      "number": 8,
